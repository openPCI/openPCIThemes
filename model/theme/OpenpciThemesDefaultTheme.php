...
namespace openPCI\openPCIThemes\model\theme;
...
/**
 * Class OpenpciThemesDefaultTheme
 *
 * @package openPCI\openPCIThemes\model\theme
 */
class OpenpciThemesDefaultTheme extends DefaultTheme
{

    /**
     * Id of this extension
     */
    const EXTENSION_ID = 'openPCIThemes';


    /**
     * Theme's label
     */
    const THEME_LABEL = 'openPCI Themes default theme';


    /**
     * Theme's id, by default label without spec chars
     */
    const THEME_ID = 'openpciThemesDefaultTheme';
